...
% solve the problem
% the last [] are the lower bound, first we have w, then b and then the
% ones for the slack variables
...
% guardando quali hanno valori maggiori di zero vedi quali punti sono
% fuori dall limite inferiore e superiore
xip = sol(3:2+l);
xim = sol(3+l:2+2*l);
